 ...
 * @author Chetan
 */
public class Greedy_BFS_H_Two_Manhatten {
    ...
    public Greedy_BFS_H_Two_Manhatten(int[] puzzle) {
        this.puzzle = puzzle;
        stack = new Stack<>();
...
//                    solutionSteps.append(node.getAction());
    ...
    public List GenerateStateNodes(Node2 node) {
        ...
        if (zeroPOS == 8) {
            ...
            stateLEFT.setCost(nodeCostCalculate.calcManhattan(stateLEFT.getPuzzle()));
            stateUP.setCost(nodeCostCalculate.calcManhattan(stateUP.getPuzzle()));
            ...
            stateLEFT.setCost(nodeCostCalculate.calcManhattan(stateLEFT.getPuzzle()));
            stateRIGHT.setCost(nodeCostCalculate.calcManhattan(stateRIGHT.getPuzzle()));
            stateUP.setCost(nodeCostCalculate.calcManhattan(stateUP.getPuzzle()));
            ...
            stateLEFT.setCost(nodeCostCalculate.calcManhattan(stateLEFT.getPuzzle()));
            stateUP.setCost(nodeCostCalculate.calcManhattan(stateUP.getPuzzle()));
            stateDOWN.setCost(nodeCostCalculate.calcManhattan(stateDOWN.getPuzzle()));
            list.add(stateLEFT);
            list.add(stateUP);
            list.add(stateDOWN);
