 ...
 * @author Chetan
 */
public class DFS_2 implements Runnable{
    ListIterator<Node2> it;
    ...
    public void solve() {
      ...
      {listNode=null;
        ...
        System.out.println("Current Node on stack" + node);
